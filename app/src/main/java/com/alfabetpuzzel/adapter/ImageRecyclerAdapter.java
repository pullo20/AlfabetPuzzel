...
public class ImageRecyclerAdapter extends RecyclerView.Adapter<ImageRecyclerAdapter.myViewHolder> {
   ...
   public ImageRecyclerAdapter(int[] drawableInts, Context context) {
   ...
   public ImageRecyclerAdapter(ArrayList<Drawable> images, Context context) {
   ...
   public void setIsDefaultImages() {
